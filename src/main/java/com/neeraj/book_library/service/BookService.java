...
//    /**
//     * Bulk creates new book entries.
//     *
//     * @param bookDTOs list of book DTOs to create
//     * @return list of created BookDTOs
//     */
...
//     * @return the BookDTO if found
//     * @throws com.neeraj.book_library.exception.BookNotFoundException if not found
//     */
...
//     * Retrieves all books without pagination.
//     *
//     * @return list of all BookDTOs
//     */
//    List<BookDTO> getAllBooksUnpaged();
//
//    /**
...
//     * @param size the number of items per page
//     * @return a paginated response containing books
//     */
//    BookPageResponse getAllBooks(int page, int size);
//
//    /**
...
//     * @throws com.neeraj.book_library.exception.BookNotFoundException if the book doesn't exist
//     */
...
//
//    /**
//     * Saves a raw Book entity. Used internally.
//     *
//     * @param book the Book entity to save
