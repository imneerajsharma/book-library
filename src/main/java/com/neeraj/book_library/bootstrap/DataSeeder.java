...
//
///**
// * Seeds initial book data from a JSON file into MongoDB at application startup.
// * Only runs if the book collection is empty to prevent duplicate data.
// */
//@Slf4j
//@Component
//public class DataSeeder implements CommandLineRunner {
...
//    private final ObjectMapper objectMapper;
//
//    public DataSeeder(BookRepository bookRepository, ObjectMapper objectMapper) {
//        this.bookRepository = bookRepository;
//        this.objectMapper = objectMapper;
//    }
//
//    /**
//     * Runs after the application starts and seeds the database if empty.
//     *
...
//            log.info("No existing books found. Seeding initial data from data.json...");
//
...
//                log.info("Successfully seeded {} books into MongoDB.", books.size());
//            } catch (Exception e) {
//                log.error("Failed to seed data from data.json: {}", e.getMessage(), e);
//            }
//        } else {
//            log.info("Book data already present. Skipping seeding process.");
//        }
